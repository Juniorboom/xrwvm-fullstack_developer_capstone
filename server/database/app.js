...
// Delete existing data and insert data from JSON files
try {
...
// Fetch dealerships from a particular state
app.get(
  '/fetchDealers/:state',
  async (req, res) => {
...
// Fetch a dealer using dealer ID
app.get(
  '/fetchDealer/:id',
  async (req, res) => {
